...
_3d.Draggable = true
_3d.Position = UDim2.new(0.520109653, -142, 0.341130584, -31)
...
TextLabel.TextColor3 = Color3.fromRGB(255, 0, 122)
...
_2d.Draggable = true
_2d.Position = UDim2.new(0.520109653, -142, 0.341130584, -31)
...
TextLabel_4.TextColor3 = Color3.fromRGB(255, 0, 137)
TextLabel_4.TextSize = 31.000
TextLabel_4.TextStrokeColor3 = Color3.fromRGB(255, 0, 137)
...
freespace.BackgroundColor3 = Color3.fromRGB(255, 0, 153)
...
freespace_2.BackgroundColor3 = Color3.fromRGB(255, 0, 168)
...
freespace_3.BackgroundColor3 = Color3.fromRGB(255, 0, 183)
...
freespace_4.BackgroundColor3 = Color3.fromRGB(255, 0, 198)
...
soon.Name = "soon"
soon.Parent = _3ddw_5
soon.BackgroundColor3 = Color3.fromRGB(255, 0, 214)
...
local function MGXYM_fake_script() -- TextLabel.Script 
	local script = Instance.new('Script', TextLabel)

	
end
coroutine.wrap(MGXYM_fake_script)()
local function MTFXCW_fake_script() -- TextLabel_4.Script 
	local script = Instance.new('Script', TextLabel_4)

	
end
coroutine.wrap(MTFXCW_fake_script)()
local function YCOAPRF_fake_script() -- freespace.Script 
	local script = Instance.new('Script', freespace)

	
end
coroutine.wrap(YCOAPRF_fake_script)()
local function BJHIPDD_fake_script() -- freespace_2.Script 
	local script = Instance.new('Script', freespace_2)

	
end
coroutine.wrap(BJHIPDD_fake_script)()
local function OMFHB_fake_script() -- freespace_3.Script 
	local script = Instance.new('Script', freespace_3)

	
end
coroutine.wrap(OMFHB_fake_script)()
local function PWDA_fake_script() -- freespace_4.Script 
	local script = Instance.new('Script', freespace_4)

	
end
coroutine.wrap(PWDA_fake_script)()
local function WSIH_fake_script() -- soon.Script 
	local script = Instance.new('Script', soon)

	
end
coroutine.wrap(WSIH_fake_script)()
